...
export default function NodeButtons(props: Props) {
  ...
  const editButtons = () => {
    return (
      <>
        ...
        <button
          className={`${styles["buttons__node-btn"]} ${styles["buttons__node--confirm"]}`}
  ...
  const defaultButtons = () => {
    return (
      <>
        ...
        <button
          className={`${styles["buttons__node-btn"]} ${styles["buttons_node-btn--delete"]}`}
          onClick={() => deleteNode(props.node)}
        >
          <CrossIcon className={styles["buttons__node-btn-icon"]} />
        </button>
